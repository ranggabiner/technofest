...
This repo uses local Supabase ports `55321` through `55329` to avoid collisions with other projects using the CLI defaults.
...
Set these in both `.env` for Supabase CLI and `.env.local` for the app:
