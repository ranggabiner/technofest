...
Once app scaffold and scripts exist, run:
...
| 2026-05-14 | Do not create speculative app folders in docs | Repository has no app scaffold yet; folder details must follow future implementation context. |
| 2026-05-14 | Documentation validation replaces app validation for doc-only work | No `package.json`, app scaffold, or scripts exist yet. |

## Open Questions

- Exact app folder layout after Next.js scaffold.
- Exact package scripts for typecheck, lint, test, and build.
- Exact Supabase migration path after scaffold.
