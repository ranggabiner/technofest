...
-- KYC secure file metadata is intentionally not seeded here because filenames and
-- file payloads must be encrypted with the active ENCRYPTION_MASTER_KEY.
-- Run scripts/seed-demo-auth-users.mjs for hosted/demo KYC storage rows.
