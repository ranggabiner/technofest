    ...
    <div className="flex min-h-screen flex-col bg-[var(--color-warm-canvas)] text-[var(--color-graphite)]">
      ...
      <main className="flex min-h-screen flex-1 items-center justify-center px-4 pb-16 pt-24 sm:px-6 sm:pb-24 sm:pt-32">
        <form
          ...
          className="relative w-full max-w-[640px] overflow-hidden rounded-xl bg-[var(--color-card)] p-5 shadow-[inset_0_0_0_1px_var(--color-stone-surface)] sm:p-8 md:p-20"
        >
          <div className="mx-auto mb-10 max-w-[480px] text-center sm:mb-16">
            <h1 className="mb-4 text-3xl font-medium leading-tight text-[var(--color-charcoal-primary)] sm:text-4xl md:text-5xl">
          ...
          {roleError ? (
            <div
              role="alert"
              className="mb-8 flex items-start gap-3 rounded-[10px] bg-[var(--color-error-surface)] p-4 text-left text-xs leading-5 text-[var(--color-error-red)]"
            >
