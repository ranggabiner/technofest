...
function AttachmentPreviewDialogFallback() {
  return (
    <ViewportModal className="bg-[color-mix(in_srgb,var(--color-ash)_32%,transparent)] p-3 backdrop-blur-sm sm:p-4">
      <ViewportModalPanel as="section" className="my-4 flex max-h-[calc(100dvh-2rem)] min-h-[520px] w-full max-w-[920px] animate-pulse flex-col overflow-hidden rounded-[18px] border border-[var(--color-stone-surface)] bg-[var(--color-card)] shadow-[0_24px_80px_rgba(18,18,18,0.18),inset_0_0_0_1px_var(--color-stone-surface)]">
