...
import { PatientProfilingClient } from "../profile-client";

export const dynamic = "force-dynamic";

export default async function PatientProfilingPage() {
  ...
  return (
    <ProfileShell role="patient" copy={copy.profile} active="profiling">
